...
<h2 class="tit">자주 묻는 질문 글쓰기</h2>
<form method="post" action="/faq/savePro" onSubmit="return check()">
	...
	<div class="form-box">
		...
		<div class="btn-box clear">
			...
			<input class="btn-item" type="button" value="글목록" onClick="location.href='/faq/list'"/>
		</div>
	</div>
</form>
