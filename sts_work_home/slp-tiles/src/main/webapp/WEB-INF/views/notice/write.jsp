...
<h2 class="tit">Notice 글쓰기</h2>
<form method="post" action="/notice/savePro" onSubmit="return check()">
	...
	<div class="form-box">
		...
		<div class="btn-box clear">
			...
			<input class="btn-item" type="button" value="글목록" onClick="location.href='/notice/list'"/>
		</div>
	</div>
</form>
